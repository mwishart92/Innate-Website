      ...
      <div className="mx-auto w-full max-w-full flex justify-bewteen lg:flex-wrap gap-[160px] lg:gap-[50px]">
        <div className="max-w-[40%] mob:max-w-[90%]">
          ...
          <Text className="text-[16px] mt-4 text-[#D9D9D9] mob:font-normal mob:text-[14px]">
            Schedule a complimentary <a href="/onboarding">30-minute consultation</a> to discuss your <a href="https://visualizer.innate-aec.com/" target="_blank" rel="noopener noreferrer">architecture or construction project</a> and determine if we're the right fit. If we are, we'll book an in-person site visit; if not, we'll point you to a better resource.
          </Text>
        </div>
        {/* right form */}
        <Form />
