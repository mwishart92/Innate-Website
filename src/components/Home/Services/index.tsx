          ...
          <div className="overflow-hidden h-full flex justify-center items-center relative">
            ...
            <div className="relative z-10">
              ...
              <div className="flex justify-center w-full">
                <Button
                  className="w-[136px] h-[50px] mob:text-[14px] bg-transparent text-white border border-white hover:bg-white hover:text-black hover:border-black transition duration-300 mob:w-[126px] mob:h-[48px] hide"
