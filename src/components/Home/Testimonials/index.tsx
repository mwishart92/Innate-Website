...
import VideoThumbnailHomeMobile from '@/components/ui/VideoThumbnailHomeMobile'
            ...
            >
              ...
              <SwiperSlide className="mob:px-3">
                <VideoThumbnailHomeMobile
                  ...
                  title="Wedgewood ADU 950 SF"
                  subtitle="ADU Project"
                  additionalText="From excavation to finishes"
                />
              </SwiperSlide>
              ...
              <SwiperSlide className="mob:px-3">
                <VideoThumbnailHomeMobile
                  ...
                  title="Norman Residence"
                  subtitle="Kitchen and Bathroom Remodel"
                  additionalText="Michael had a great vision"
                />
              </SwiperSlide>
            </Swiper>
