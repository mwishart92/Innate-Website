  ...
  return (
    <div className="w-full overflow-hidden mt-16">
      <div className="w-full overflow-hidden TestimonialSlider-slider-parent">
        {/* <h2 className="font-inter text-[40px] font-medium text-white mob:leading-normal leading-[52px] text-center w-full px-8"> */}
        <Text
          as="h2"
          className="font-inter text-[40px] font-medium text-white mob:leading-normal leading-[52px] text-center w-full px-8"
        >
