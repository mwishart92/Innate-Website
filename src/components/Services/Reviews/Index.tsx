...
import leftdot from "@/public/images/services/dot-left.svg";
import rightdot from "@/public/images/services/dot-right.svg";
...
const Reviews: React.FC<ReviewsProps> = ({ text, name, title }) => {
  return (
    <div className="pt-32 pb-20 tab:px-8">
      <div className="w-full max-w-[1104px] mx-auto relative">
        <Image
          className="absolute left-0 tab:top-[-80px] top-[-80px] mob:top-[-80px] w-[74.95px] h-[64px] mob:w-[46.84px] mob:h-[40px] mob:bottom-[40px]"
          src={leftdot}
          alt=""
        />
        <Image
          className="absolute right-0 bottom-[50px] w-[74.95px] h-[64px] mob:w-[46.84px] mob:h-[40px] mob:bottom-[40px]"
          src={rightdot}
          alt=""
        />
