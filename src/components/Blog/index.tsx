...
function generateSlug(title: string): string {
  return title
    ...
    .split("-")
    .slice(0, 7) // Limit to 7 words for brevity
    .join("-");
}
                    ...
                    <ol>
                      {item.text
                        ...
                        .map((line, idx) => {
                          ...
                          return (
                            <li
                              className="my-5 text-[16px] font-normal mob:text-[14px]"
                              key={idx}
                            >
                              {line.trim()}
                            </li>
            ...
            {selectedSections.map((section) =>
              section.content?.map((contentItem, index) => (
                <div
                  ...
                  className="flex items-center gap-[16px] mb-[28px] w-full"
                >
