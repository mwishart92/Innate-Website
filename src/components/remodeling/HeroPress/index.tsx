      ...
      <div className="w-full max-w-full mob:px-5 min-h-[488px] mob:min-h-[388px] relative h-full flex flex-col justify-center items-center mt-[100px]">
        ...
        <div className="w-full">
          ...
          >
            ...
            bathroom remodels, whole-home renovations, additions, or ADUs. Learn
            what drives cost, complexity, and timelines, and get a clearer sense
            of what’s realistic before you begin.
          </Text>
        </div>
      </div>
    </div>
