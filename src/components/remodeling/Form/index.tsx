    ...
    <>
      <div className="w-full mb-28 mob:px-5">
        ...
        <div className=" mt-16">
          <Text
            as="h2"
            className="text-[32px] text-[#D9D9D9] mob:text-[27px] font-light leading-[70.4px] mob:leading-[50.4px] text-center "
          >
            The Ultimate Construction Cost Guide [2026 Edition]
          </Text>
          <Text
            as="h2"
            className="text-[48px] text-[#D9D9D9] mob:text-[30px] font-medium leading-[70.4px] mob:leading-[50.4px] text-center mt-6"
          >
            Get your FREE copy
          </Text>
        </div>
        ...
        <form
          ...
          className="w-full max-w-[611px] mx-auto mt-12"
        >
