  ...
  return (
    <div className="w-full h-screen flex justify-center items-center relative overflow-hidden">
      <div className="absolute inset-0 flex justify-center items-center w-full h-full z-20">
        {/* Text content */}
        <div className="absolute xl:bottom-96 mob:bottom-80 left-0 p-5 mob:p-10 w-full z-20 bg-opacity-50 text-center">
          {imageLoaded && (
            <div>
              <Text
                as="h1"
                className="text-[74px] font-semibold text-[#FFFFFF] mob:text-[29.29px] text-center mob:hidden"
              >
                Shoreline Residence
              </Text>
              <Text
                as="h1"
                className="text-[74px] font-semibold text-[#FFFFFF] mob:text-[29.29px] text-center sm:hidden"
              >
                Shoreline
                <br /> Residence
              </Text>
              ...
              <Link
                href="/project/shoreline-residence"
        ...
        <div className="w-full work1-slider-parent flex justify-center items-center relative">
          {/* Navigation Arrows */}
          <Image
            className="cards-custom-prev11 absolute left-4 top-1/2 transform -translate-y-1/2 cursor-pointer rotate-180"
            onClick={handleprevbtn}
            src={arrow}
            alt="moveprevbtn"
          />
          <Image
            className="cards-custom-next11 absolute right-4 top-1/2 transform -translate-y-1/2 cursor-pointer"
