    ...
    <>
      <div className="max-w-[1203px] mx-auto">
        <div className="w-full px-10 flex flex-col md:gap-20 gap-4 mb-10 md:mb-28">
          ...
          <div className="">
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: projectDetails.scopedescription || "",
              }}
            ></div>
          ...
          projectDetails?.alternatingLayout ? (
            <div className="flex flex-col gap-12">
              {projectDetails.sideImages.map((item: any, index: any) => {
                const isEven = index % 2 === 0;
                const description = projectDetails?.description?.[index] || "";
                ...
                return (
                  <div
                    key={index}
                    className="flex mob:flex-col gap-8 items-center justify-center"
                  >
                    {isEven ? (
                      <>
                        {TextBlock}
          ...
          <div className="flex flex-col items-center">
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: projectDetails.galleryDescription || "",
              }}
            ></div>
            ...
            <div className="flex flex-col md:items-end justify-center ">
              <div className="md:max-w-[441px]">
                <Text className="self-center">
                  My love of architecture started at a very young age. As a
                  child growing up in Australia, I would create structures with
                  blocks and sketch my dream house. Years later, I studied
                  architecture at the Community College of Denver, where I
                  discovered the timeless art of hand drafting. Although we
                  fully embrace modern technology at Innate, I believe something
                  special happens when you put pencil to paper. It’s a tactile
                  connection that brings authentic quality to every project we
                  do.
                  <br />
                  <br />
                  Since Innate started, our philosophy has been simple: it is
                  our mission to enhance our clients’ quality of life. We
                  collaborate with architects, engineers, and craftsmen who
                  share our values. Innate is a multi-disciplinary firm capable
                  of handling entire projects from initial concept to finished
                  construction.
                </Text>
                <Link href="/onboarding">
                  <button
